...
@section('content')
	...
	<div class="container-wrap">
		...
		<div id="fh5co-work" class="fh5co-light-grey">
			...
			<div class="row">
				<div class="col-md-4 text-center animate-box">
					<a href="work-single" class="work"  style="background-image: url(images/portfolio-1.jpg);">
						<div class="desc">
							<h3>Project Name</h3>
				...
				<div class="col-md-4 text-center animate-box">
					<a href="work-single" class="work" style="background-image: url(images/portfolio-2.jpg);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Brading</span>
						</div>
				...
				<div class="col-md-4 text-center animate-box">
					<a href="work-single" class="work" style="background-image: url(images/portfolio-3.jpg);">
						<div class="desc">
							<h3>Project Name</h3>
							<span>Illustration</span>
						</div>
